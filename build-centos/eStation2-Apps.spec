...
Group: eStation
License: GPL
Source: /home/adminuser/rpms/Apps/%{name}-%{version}-%{release}.tgz
...
# Create the .tgz
cd src
tar -cvzf /home/adminuser/rpms/%{name}-%{version}-%{release}.tgz *

# Prepare the files in BUILD_ROOT
rm -rf $RPM_BUILD_ROOT
mkdir -p $RPM_BUILD_ROOT/var/www/eStation2-%{version}
cd $RPM_BUILD_ROOT
cp /home/adminuser/rpms/%{name}-%{version}-%{release}.tgz ./var/www/eStation2-%{version}
