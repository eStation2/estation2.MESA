...
def create_pipeline(prod, starting_sprod, mapset, version, starting_dates_linearx2=None, proc_lists=None,
    ...
    input_dir_linearx2 = es2_data_dir + functions.set_path_sub_directory(prod, input_subprod_linearx2, 'Derived',
                                                                         version, mapset)
    ...
    formatter_out = [
        "{subpath[0][5]}" + os.path.sep + subdir_linearx2_agric + "{YYYYMMDD[0]}" + prod_ident_linearx2_agric]
    ...
    @collate(starting_files_linearx2, formatter("[0-9]{4}(?P<MMDD>[0-9]{4})" + in_prod_ident_linearx2),
    ...
    formatter_out = [
        "{subpath[0][5]}" + os.path.sep + subdir_10dmin_linearx2 + "{MMDD[0]}" + prod_ident_10dmin_linearx2]
    ...
    formatter_in = "[0-9]{4}(?P<MMDD>[0-9]{4})" + in_prod_ident_linearx2
    formatter_out = [
        "{subpath[0][5]}" + os.path.sep + subdir_10dmax_linearx2 + "{MMDD[0]}" + prod_ident_10dmax_linearx2]
    ...
    formatter_in = "[0-9]{4}(?P<MMDD>[0-9]{4})" + in_prod_ident_linearx2
    formatter_out = [
        "{subpath[0][5]}" + os.path.sep + subdir_10dmed_linearx2 + "{MMDD[0]}" + prod_ident_10dmed_linearx2]
    ...
    formatter_out = [
        "{subpath[0][5]}" + os.path.sep + subdir_year_min_linearx2 + "{YYYY[0]}" + prod_ident_year_min_linearx2]
    ...
    formatter_in = "(?P<YYYY>[0-9]{4})[0-9]{4}" + in_prod_ident_linearx2
    formatter_out = [
        "{subpath[0][5]}" + os.path.sep + subdir_year_max_linearx2 + "{YYYY[0]}" + prod_ident_year_max_linearx2]
    ...
    in_prod_ident_year_min_linearx2 = functions.set_path_filename_no_date(prod, input_subprod_year_min_linearx2, mapset,
                                                                          version, ext)

    input_dir_year_min_linearx2 = es2_data_dir + \
                                  functions.set_path_sub_directory(prod, input_subprod_year_min_linearx2, 'Derived',
                                                                   version, mapset)
    ...
    formatter_out = [
        "{subpath[0][5]}" + os.path.sep + subdir_absol_min_linearx2 + 'Overall' + prod_ident_absol_min_linearx2]
    ...
    in_prod_ident_year_max_linearx2 = functions.set_path_filename_no_date(prod, input_subprod_year_max_linearx2, mapset,
                                                                          version, ext)

    input_dir_year_max_linearx2 = es2_data_dir + \
                                  functions.set_path_sub_directory(prod, input_subprod_year_max_linearx2, 'Derived',
                                                                   version, mapset)
    ...
    formatter_out = [
        "{subpath[0][5]}" + os.path.sep + subdir_absol_max_linearx2 + 'Overall' + prod_ident_absol_max_linearx2]
    ...
    def vgt_ndvi_baresoil(input_file, output_file):
        ...
        output_file = functions.list_to_element(output_file)
        functions.check_output_dir(os.path.dirname(output_file))
        args = {"input_file": current_file, "avg_file": average_file, "output_file": output_file,
                "output_format": 'GTIFF', "ndvi_max": 0.18, "options": "compress = lzw"}
    ...
    formatter_in = "(?P<YYYY>[0-9]{4})(?P<MMDD>[0-9]{4})" + in_prod_ident_linearx2
    formatter_out = [
        "{subpath[0][5]}" + os.path.sep + subdir_baresoil_linearx2 + "{YYYY[0]}{MMDD[0]}" + prod_ident_baresoil_linearx2]
    ...
    formatter_in = "(?P<YYYY>[0-9]{4})(?P<MMDD>[0-9]{4})" + in_prod_ident
    formatter_out = [
        "{subpath[0][5]}" + os.path.sep + subdir_diff_linearx2 + "{YYYY[0]}{MMDD[0]}" + prod_ident_diff_linearx2]
    ...
    formatter_in = "(?P<YYYY>[0-9]{4})(?P<MMDD>[0-9]{4})" + in_prod_ident_linearx2
    formatter_out = [
        "{subpath[0][5]}" + os.path.sep + subdir_linearx2_diff_linearx2 + "{YYYY[0]}{MMDD[0]}" + prod_ident_linearx2_diff_linearx2]
    ...
    @transform(starting_files_linearx2_all, formatter(formatter_in), add_inputs(ancillary_input_1, ancillary_input_2),
               formatter_out)
    ...
    @transform(starting_files, formatter(formatter_in),
               add_inputs(ancillary_input_1, ancillary_input_2, ancillary_input_3), formatter_out)
    ...
    formatter_in = "(?P<YYYY>[0-9]{4})(?P<MMDD>[0-9]{4})" + in_prod_ident_linearx2
    formatter_out = [
        "{subpath[0][5]}" + os.path.sep + subdir_vci_linearx2 + "{YYYY[0]}{MMDD[0]}" + prod_ident_vci_linearx2]
    ...
    @transform(starting_files_linearx2_all, formatter(formatter_in),
               add_inputs(ancillary_input_1, ancillary_input_2, ancillary_input_3), formatter_out)
    ...
    formatter_in = "(?P<YYYY>[0-9]{4})(?P<MMDD>[0-9]{4})" + in_prod_ident_linearx2
    formatter_out = [
        "{subpath[0][5]}" + os.path.sep + subdir_icn_linearx2 + "{YYYY[0]}{MMDD[0]}" + prod_ident_icn_linearx2]
    ...
    @transform(starting_files_linearx2_all, formatter(formatter_in), add_inputs(ancillary_input, ancillary_input_1),
               formatter_out)
    @follows(vgt_ndvi_10davg_linearx2, vgt_ndvi_baresoil_linearx2)
    def vgt_ndvi_ratio_linearx2(input_file, output_file):
        ...
        args = {"input_file": [current_file, avg_file], "output_file": output_file_temp, "output_format": 'GTIFF',
                "options": "compress = lzw"}
    ...
    @transform(starting_files_10ddiff, formatter(formatter_in), add_inputs(ancillary_input, ancillary_input_1),
               formatter_out)
    ...
    in_prod_ident_baresoil_linearx2 = functions.set_path_filename_no_date(prod, input_subprod_baresoil_linearx2, mapset,
                                                                          version, ext)

    input_dir_baresoil_linearx2 = es2_data_dir + functions.set_path_sub_directory(prod, input_subprod_baresoil_linearx2,
    ...
    def vgt_ndvi_1monstddev(input_file, output_file):
        ...
        output_file = functions.list_to_element(output_file)
        functions.check_output_dir(os.path.dirname(output_file))
        args = {"input_file": current_file, "avg_file": avg_file, "output_format": 'GTIFF', "options": "compress=lzw",
                "output_stddev": output_file}
        raster_image_math.do_stddev_image(**args)
    ...
    @transform(starting_files_monndvi, formatter(formatter_in),
               add_inputs(ancillary_input_1, ancillary_input_2, ancillary_input_3), formatter_out)
    ...
    @transform(starting_files_monndvi, formatter(formatter_in),
               add_inputs(ancillary_input_1, ancillary_input_2, ancillary_input_3), formatter_out)
    @follows(vgt_ndvi_absol_min_linearx2, vgt_ndvi_absol_max_linearx2, vgt_ndvi_monbaresoil,
             vgt_ndvi_monthly_vci_linearx2)
    ...
    @transform(starting_files_monndvi, formatter(formatter_in), add_inputs(ancillary_input, ancillary_input_1),
               formatter_out)
...
def processing_std_ndvi(res_queue, pipeline_run_level=0, pipeline_printout_level=0,
                        ...
                        starting_dates_linearx2=None, update_stats=False, nrt_products=True, write2file=None,
                        logfile=None,
    ...
    if pipeline_run_level > 0:
        pipeline_run(verbose=pipeline_run_level, logger=spec_logger, touch_files_only=touch_files_only,
                     history_file=os.path.join(es_constants.log_dir,
                                               '.ruffus_history_' + prod + '_' + version + '.sqlite'),
                     checksum_level=0)
