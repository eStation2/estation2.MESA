...
class SubProcessStatsES2(object):
    ...
    def do_average(self):
        ...
        #   Average
            ...
            prod_ident_1monavg = functions.set_path_filename_no_date(self.prod, output_sprod, self.mapset, self.version, self.ext)
            subdir_1monavg = functions.set_path_sub_directory(self.prod, output_sprod, 'Derived', self.version, self.mapset)
    ...
    def do_minimum(self):
        ...
        if self.frequency == '10d':
            ...
            prod_ident_1monmin = functions.set_path_filename_no_date(self.prod, output_sprod, self.mapset, self.version, self.ext)
            subdir_1monmin = functions.set_path_sub_directory(self.prod, output_sprod, 'Derived', self.version, self.mapset)
    ...
    def do_maximum(self):
        ...
        if self.frequency == '10d':
            ...
            prod_ident_1monmax = functions.set_path_filename_no_date(self.prod, output_sprod, self.mapset, self.version, self.ext)
            subdir_1monmax = functions.set_path_sub_directory(self.prod, output_sprod, 'Derived', self.version, self.mapset)
    ...
    # #  standard deviation
        if self.frequency == '10d':
            ...
            prod_ident_10dstd = functions.set_path_filename_no_date(self.prod, output_sprod, self.mapset, self.version, self.ext)
            subdir_10dstd = functions.set_path_sub_directory(self.prod, output_sprod, 'Derived', self.version, self.mapset)
            ...
            prod_ident_1mondev = functions.set_path_filename_no_date(self.prod, output_sprod,self.mapset, self.version, self.ext)
            subdir_1mondev = functions.set_path_sub_directory(self.prod, output_sprod, 'Derived', self.version, self.mapset)
