...
def create_pipeline(prod, starting_sprod, mapset, version, starting_dates=None, proc_lists=None,
    ...
    subprocess_prods = subprocess_std_prods.SubProcessProdsES2(prod=prod, starting_sprod=starting_sprod, mapset=mapset, version=version,
                                                               starting_dates=starting_dates, proc_lists=proc_lists, frequency='10d')
    ...
    @transform(subprocess_prods.starting_files, formatter(subprocess_prods.formatter_in), add_inputs(subprocess_prods.ancillary_input_1, subprocess_prods.ancillary_input_2), subprocess_prods.formatter_out)
    ...
    @transform(subprocess_prods.starting_files, formatter(subprocess_prods.formatter_in), add_inputs(subprocess_prods.ancillary_input_1), subprocess_prods.formatter_out)
    ...
    @transform(subprocess_prods.starting_files_10ddiff, formatter(subprocess_prods.formatter_in), add_inputs(subprocess_prods.ancillary_input), subprocess_prods.formatter_out)
    ...
    @collate(subprocess_stats.starting_files_mon_prod, formatter(subprocess_stats.formatter_in), subprocess_stats.formatter_out)
    ...
    @follows(vgt_1monavg)
    @collate(subprocess_stats.starting_files_mon_prod, formatter(subprocess_stats.formatter_in), add_inputs(subprocess_stats.ancillary_input), subprocess_stats.formatter_out)
