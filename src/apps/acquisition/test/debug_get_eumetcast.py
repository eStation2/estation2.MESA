...
#
#   Initially called test_get_eumetcast.py it is renamed in June 2020 when the new module implemented
#   for doing meaningful tests for the get_eumetcast()
#
class TestGetEumetcast(unittest.TestCase):
    ...
    def test_GetEumetcast_PC2_nodir(self):
