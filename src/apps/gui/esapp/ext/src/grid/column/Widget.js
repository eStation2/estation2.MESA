...
Ext.define('Ext.grid.column.Widget', {
    ...
    privates: {
        ...
        onTreeViewItemRemove: function(record, index, view) {
            // This shim is here because TreeView's itemremove event signature
            // is different from Table View. In 6.0+ both Views will fire this event
            // with the same parameters; in 5.x we have to use a shim because
            // changing event signature is a breaking change and is not desirable.
