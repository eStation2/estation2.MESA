        ...
        for (var i = 0; i < selectedGraphTemplates.length; i++) {
           // console.info(selectedGraphTemplates[i]);
            ...
            var graphTemplate = {
                ...
                // disclaimerObjPosition: selectedGraphTemplates[i].data.disclaimerobjposition.split(",").map(function(x){return parseInt(x)}),
                // disclaimerObjContent: selectedGraphTemplates[i].data.disclaimerobjcontent,
                // logosObjPosition: selectedGraphTemplates[i].data.logosobjposition.split(",").map(function(x){return parseInt(x)}),
                // logosObjContent: Ext.decode(selectedGraphTemplates[i].data.logosobjcontent),
            ...
            analysisMain.add(newGraphViewWin);
