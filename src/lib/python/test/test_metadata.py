...
class TestMetaData(unittest.TestCase):
    ...
    def test_get_gdalinfo(self):
        my_file = self.testdatadir+'/wsi-hp/pasture/20200221_wsi-hp_pasture_SPOTV-Africa-1km_V1.0.tif'
        gdal_info = GdalInfo()
        status = gdal_info.get_gdalinfo(my_file, print_out=True)
        self.assertEqual(status, 0)

    def test_compare_gdalinfo(self):
        my_file1 = self.testdatadir+'/wsi-hp/pasture/20200221_wsi-hp_pasture_SPOTV-Africa-1km_V1.0.tif'
        my_file2 = self.testdatadir+'/wsi-hp/pasture/20200221_wsi-hp_pasture_SPOTV-Africa-1km_V1.0.tif'
        gdal_info1 = GdalInfo()
        gdal_info2 = GdalInfo()
