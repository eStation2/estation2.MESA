# M.C. 14.01.2021 -> To be commented for tests in main/python2 (mesa-proc) otherwise gives an error in
...
class TestRasterImage(unittest.TestCase):
    ...
    def test_oper_division_perc(self):
        ...
        max_delta = 1.1
        equal = self.checkFile(ref_file, output_file, max_delta=max_delta,create_plot=False)
        self.assertEqual(equal,1)
        #
        #
    ...
    # Tested ok on 13.01.2021 (MC)
    def test_make_vci_baresoil_ndvi(self):
