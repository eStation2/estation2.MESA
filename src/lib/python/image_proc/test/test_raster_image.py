...
class TestRasterImage(unittest.TestCase):
    ...
    #Tested --> Matching but file size different
    ...
    # Continue from HERE !!!! output not matching-- 10dratio fewsnet is not computed with this method?
    ...
    def test_make_vci(self):
        ...
        #                self.ref_avg_file]
        #input_file= self.ref_dir+'/vgt-ndvi/ndv/20200301_vgt-ndvi_ndv_SPOTV-Africa-1km_sv2-pv2.2.tif'
        ...
        # output_file = self.root_out_dir+'/vgt-ndvi/baresoil-linearx2/20200301_vgt-ndvi_baresoil-linearx2_SPOTV-Africa-1km_sv2-pv2.2.tif'
        # functions.check_output_dir(os.path.dirname(output_file))
    ...
    def test_make_baresoil(self):
        ...
        args = {"input_file": input_file, "min_file": min_file, "max_file": max_file, "output_file": output_file, "output_format": 'GTIFF', "options": "compress = lzw", "input_nodata":-32768}
    ...
    def test_compute_primary_production(self):
        ...
        args = {"chla_file": input_files[0], "sst_file": input_files[1], "kd_file": input_files[2],
                ...
                "par_nodata": 0, "output_file": output_file, "output_nodata": -32767,
                "output_format": 'GTIFF', \
    ...
    # Not matching - though parameters are same
