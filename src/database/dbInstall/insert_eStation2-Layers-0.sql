...
ALTER SEQUENCE analysis.layers_layerid_seq RESTART WITH 40;

SELECT analysis.update_insert_layers( layerid := 40, layerlevel := 'admin0', layername := 'ICPAC level 0', description := 'ICPAC level 0', filename := 'RIC_ICPAC_0_g2015_2014.geojson', layerorderidx := 4, layertype := 'polygon', polygon_outlinecolor := '#319FD3', polygon_outlinewidth := 2, polygon_fillcolor := 'Transparent', polygon_fillopacity := 1, feature_display_column := 'ADM0_NAME', feature_highlight_outlinecolor := '#319FD3', feature_highlight_outlinewidth := 2, feature_highlight_fillcolor := '#319FD3', feature_highlight_fillopacity := 10, feature_selected_outlinecolor := '#FF0000', feature_selected_outlinewidth := 2, enabled := true, deletable := false, background_legend_image_filename := NULL, projection := NULL, submenu := 'ICPAC', menu := 'border', defined_by := 'JRC', open_in_mapview := false, provider := 'FAO Gaul 2015', full_copy := false );
SELECT analysis.update_insert_layers( layerid := 41, layerlevel := 'admin1', layername := 'ICPAC level 1', description := 'ICPAC level 1', filename := 'RIC_ICPAC_1_g2015_2014.geojson', layerorderidx := 3, layertype := 'polygon', polygon_outlinecolor := '#ffcc00', polygon_outlinewidth := 2, polygon_fillcolor := 'Transparent', polygon_fillopacity := 1, feature_display_column := 'ADM0_NAME, ADM1_NAME', feature_highlight_outlinecolor := '#319FD3', feature_highlight_outlinewidth := 2, feature_highlight_fillcolor := '#319FD3', feature_highlight_fillopacity := 10, feature_selected_outlinecolor := '#FF0000', feature_selected_outlinewidth := 2, enabled := true, deletable := false, background_legend_image_filename := NULL, projection := NULL, submenu := 'ICPAC', menu := 'border', defined_by := 'JRC', open_in_mapview := false, provider := 'FAO Gaul 2015', full_copy := false );
SELECT analysis.update_insert_layers( layerid := 42, layerlevel := 'admin2', layername := 'ICPAC level 2', description := 'ICPAC level 2', filename := 'RIC_ICPAC_2_g2015_2014.geojson', layerorderidx := 2, layertype := 'polygon', polygon_outlinecolor := '#808080', polygon_outlinewidth := 1, polygon_fillcolor := 'Transparent', polygon_fillopacity := 1, feature_display_column := 'ADM0_NAME, ADM1_NAME, ADM2_NAME', feature_highlight_outlinecolor := '#319FD3', feature_highlight_outlinewidth := 2, feature_highlight_fillcolor := '#319FD3', feature_highlight_fillopacity := 10, feature_selected_outlinecolor := '#FF0000', feature_selected_outlinewidth := 2, enabled := true, deletable := false, background_legend_image_filename := NULL, projection := NULL, submenu := 'ICPAC', menu := 'border', defined_by := 'JRC', open_in_mapview := false, provider := 'FAO Gaul 2015', full_copy := false );
