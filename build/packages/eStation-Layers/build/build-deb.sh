...
#
#   Script to create the eStation2-layers debian package
#   It also replaces placeholders in pre/postinst files

# Source the eStation2 specific definitions

. ../../eStation-Apps/build/eStation2_config

Project=eStation-
Name=eStation-Layers
...
mkdir -p ${BUILDdir}${ESTATION2_BASE_DIR_LAYERS}
echo ${BUILDdir}${ESTATION2_BASE_DIR_LAYERS}
cp -r ${ESTATION2_LOCAL_DIR_LAYERS}/* ${BUILDdir}${ESTATION2_BASE_DIR_LAYERS}
